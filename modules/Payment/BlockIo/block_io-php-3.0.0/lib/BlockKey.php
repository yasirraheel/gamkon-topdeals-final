...
class BlockKey
{
    ...
    public function calculateYWithX($x, $derEvenOrOddCode = null)
    {
        ...
        if (! $derEvenOrOddCode) {
            ...
            $resY = null;
            if (gmp_strval(gmp_mod($y[0], gmp_init(2, 10)), 10) == false) {
                $resY = gmp_strval($y[0], 16);
            }
            if (gmp_strval(gmp_mod($y[1], gmp_init(2, 10)), 10) == false) {
            ...
            $resY = null;
            if (gmp_strval(gmp_mod($y[0], gmp_init(2, 10)), 10) == true) {
                $resY = gmp_strval($y[0], 16);
            }
            if (gmp_strval(gmp_mod($y[1], gmp_init(2, 10)), 10) == true) {
                $resY = gmp_strval($y[1], 16);
            }
            if ($resY) {
                while (strlen($resY) < 64) {
