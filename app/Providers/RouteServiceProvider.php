...
use App\Http\Middleware\UserTypeRouteProtect;
...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->routes(function () {
            ...
            Route::prefix('seller')
                ->name('seller.')
                ->middleware(['auth', '2fa', 'isActive', 'translate', setting('otp_verification', 'permission') ? 'otp' : 'web', setting('email_verification', 'permission') ? 'verified' : 'web', UserTypeRouteProtect::class])
