...
<div class="col-sm-6 col-md-4 col-lg-3">
    <div class="minimal-product-card {{ isset($hasAnimation) ? 'wow img-custom-anim-top' : '' }}" data-wow-duration="1s"
        ...
        <div style="margin-bottom: 8px; display: flex; gap: 6px; align-items: center; flex-wrap: wrap;">
            ...
            {{-- Tier Pricing Badge --}}
            @if($showTierPricing)
                <span style="background: linear-gradient(135deg, #10b981 0%, #34d399 100%); color: #fff; padding: 5px 10px; border-radius: 12px; font-size: 10px; font-weight: 700; display: inline-flex; align-items: center; gap: 4px; box-shadow: 0 2px 6px rgba(16, 185, 129, 0.3);">
