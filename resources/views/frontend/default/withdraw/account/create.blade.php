            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <a href="{{ buyerSellerRoute('withdraw.account.index') }}" class="card-header-link"><i
                                data-lucide="alert-circle"></i>{{ __('Withdraw Account') }}</a>
                    </div>
                </div>
                <form action="{{ buyerSellerRoute('withdraw.account.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
