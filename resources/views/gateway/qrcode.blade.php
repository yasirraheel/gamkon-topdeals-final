...
@section('content')
    <!-- Modal -->
    <div class="modal fade deposit-modal" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mb-0">
                        {{ __('You can send :amount :currency to the above address', ['amount' => $data['amount'], 'currency' => $data['currency']]) }}
                    </p>
                    <p class="mb-0"><i
                            class="anticon anticon-bank"></i>{{ __('Pay Amount:') . ' ' . $data['amount'] . ' ' . $data['currency'] }}
                    </p>
                </div>
            </div>
        </div>
