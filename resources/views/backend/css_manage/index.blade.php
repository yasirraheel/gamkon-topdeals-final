                ...
                <div class="col-xl-12">
                    <div class="site-card">
                        <div class="site-card-body">
                            <div class="paragraph mb-4"><i data-lucide="alert-triangle"></i>{!! __(
                                'You can add <strong>Custom CSS</strong> to write the css below and it will effect on the <strong>User Front End Pages</strong>',
                            ) !!}</div>
