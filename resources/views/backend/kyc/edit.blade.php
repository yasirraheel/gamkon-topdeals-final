                                ...
                                <div class="col-xl-3">
                                    <div class="site-input-groups">
                                        ...
                                        <select name="user_type" class="form-select" id="">
                                            ...
                                            <option @selected($kyc->user_type=='seller') value="seller">{{ __('Seller') }}</option>
                                            <option @selected($kyc->user_type=='both') value="both">{{ __('Both') }}</option>
                                        </select>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="site-input-groups">
                                                        <select name="fields[{{$key}}][type]"
                                                            ...
                                                            <option @selected($value['type'] == 'date') value="date">Calendar</option>
