                ...
                <div class="row">
                    <div class="col">
                        <div class="title-content">
                            <h2 class="title">{{ __('ID Verification') }}</h2>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($kycs as $kyc)
                                        <tr>
                                            ...
                                            <td>
                                                @if($kyc->user_type == 'seller')
                                                    <div class="site-badge success">{{ __('Seller') }}</div>
                                                @elseif ($kyc->user_type == 'buyer')
                                                    <div class="site-badge pending">{{ __('Buyer') }}</div>
                                                    @else
                                                    <div class="site-badge primary">{{ __('Both') }}</div>
                                                @endif
                                            </td>
                                            <td>
