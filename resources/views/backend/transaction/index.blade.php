                        ...
                        <table class="table">
                            ...
                            @forelse($transactions as $transaction)
                                <tr>
                                    ...
                                    <td>
                                        @include('backend.transaction.include.__txn_amount', ['txnType' => $transaction->type, 'amount' => $transaction->final_amount, 'currency' => $transaction->pay_currency])
                                    </td>
                                    <td>
