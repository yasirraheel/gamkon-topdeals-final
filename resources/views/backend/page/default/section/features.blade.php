...
@section('content')
    <div class="main-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Features Section') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
                        ...
                        <div class="site-card">
                            ...
                            <div class="site-card-body">
                                <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                    ...
                                    <div class="site-input-groups row">
                                        <label for="description" class="col-sm-3 col-label">{{ __('Description') }}</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="description" class="box-input"
                                                placeholder="Lorem Ipsum is simply text dummy text of the"
            ...
            <div class="site-card">
                <div class="site-card-header">
                    <h3 class="title">{{ __('Features Section Contents') }}</h3>
    ...
    <!-- Modal for Add New  -->
    @include('backend.page.' . site_theme() . '.section.include.__add_new_data', ['type' => 'features'])
