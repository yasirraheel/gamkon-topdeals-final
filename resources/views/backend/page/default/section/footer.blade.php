                            ...
                            <div class="site-card-body">
                                <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                    ...
                                    <div class="site-input-groups row">
                                        <label for=""
                                            class="col-sm-3 col-label">{{ __('Contact Email Address') }}<i
                                    ...
                                    <div class="site-input-groups row">
                                        <label for=""
                                            class="col-sm-3 col-label">{{ __('Footer Widget 1 Title') }}<i
                                                data-lucide="info" data-bs-toggle="tooltip" title=""
                                                data-bs-original-title="Change the Footer Widget 1 Title"></i></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="footer_widget_1_title" class="box-input"
                                                value="{{ $data->footer_widget_1_title }}">
                                        </div>
                                    </div>

                                    <div class="site-input-groups row">
                                        <label for=""
                                            class="col-sm-3 col-label">{{ __('Footer Widget 2 Title') }}<i
                                                data-lucide="info" data-bs-toggle="tooltip" title=""
                                                data-bs-original-title="Change the Footer Widget 2 Title"></i></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="footer_widget_2_title" class="box-input"
                                                value="{{ $data->footer_widget_2_title }}">
                                        </div>
                                    </div>

                                    <div class="site-input-groups row">
                                        <label for=""
                                            class="col-sm-3 col-label">{{ __('Footer Widget 3 Title') }}<i
                                                data-lucide="info" data-bs-toggle="tooltip" title=""
                                                data-bs-original-title="Change the Footer Widget 3 Title"></i></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="footer_widget_3_title" class="box-input"
                                                value="{{ $data->footer_widget_3_title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="site-input-groups row">
                                        <label for="" class="col-sm-3 col-label">{{ __('Footer Image') }}<i
                                                data-lucide="info" data-bs-toggle="tooltip" title=""
                                                data-bs-original-title="Footer image like accepted payment method"></i></label>
                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                                            <div class="wrap-custom-file">
                                                <input type="file" name="left_img" id="leftSmallestImg"
                                                    accept=".gif, .jpg, .png" />
                                                <label for="leftSmallestImg" id="left_img"
                                                    @if ($data['left_img']) class="file-ok" style="background-image: url({{ asset($data['left_img']) }})" @endif>
                                    ...
                                    <div class="row mb-4">
                                        <div class="offset-sm-3 col-sm-9">
                                            <div class="paragraph"><i
                                                    data-lucide="alert-triangle"></i>{{ __('All the') }}
