...
@section('content')
    <div class="main-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Trending Items') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                @csrf
                                <input type="hidden" name="section_code" value="trending-items">
        ...
        <div class="section-design-nb">
            <strong>NB:</strong>{{ __('All Listing items will come from') }} <a href="{{ route('admin.listing.index') }}">{{ __('Listing') }}</a>
            {{ __('page') }}
        </div>
         </div>
    </div>
