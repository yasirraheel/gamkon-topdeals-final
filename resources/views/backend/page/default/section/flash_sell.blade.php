    ...
    <div class="main-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Flash Sale') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
                        ...
                        <div class="site-card">
                            ...
                            <div class="site-card-body">
                                <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                    ...
                                    @csrf
                                    <input type="hidden" name="section_code" value="flash_sell">
                                    ...
                                    @if ($key == 'en')
                                        <div class="site-input-groups row">
                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-label">
                                                {{ __('Image') }} <small>({{ __('420x375') }})</small>
                                            </div>
            ...
            <div class="section-design-nb">
                <strong>NB:</strong>{{ __('All Listing items will come from') }} <a
                    href="https://temporix.tdevs.co/admin/listing">{{ __('Listing when flash sale is enabled') }}</a>
                {{ __('page') }}
            </div>
        </div>
    </div>
