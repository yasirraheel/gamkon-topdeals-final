...
@section('content')
    <div class="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="site-card">
                            ...
                            <div class="site-card-body">
                                <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                    ...
                                    @csrf
                                    <input type="hidden" name="section_code" value="about-stats">
                ...
                <div class="site-card">
                    <div class="site-card-header">
                        <h3 class="title">{{ __('Counter Section Contents') }}</h3>
    ...
    <!-- Modal for Add New  -->
    @include('backend.page.' . site_theme() . '.section.include.__add_new_state')
    <!-- Modal for Add New How It Works End -->

    <!-- Modal for Edit -->
    @include('backend.page.' . site_theme() . '.section.include.__edit_state')
    <!-- Modal for Edit  End-->
