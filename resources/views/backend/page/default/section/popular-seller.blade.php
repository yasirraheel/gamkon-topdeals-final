...
@section('content')
    <div class="main-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Popular Seller') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                @csrf
                                <input type="hidden" name="section_code" value="popular-seller">
        ...
        <div class="section-design-nb">
            <strong>NB:</strong>{{ __('All Popular Seller will come from') }} <a href="{{ route('admin.user.sellers.all') }}">{{ __('Seller') }}</a>
            {{ __('page') }}
        </div>
         </div>
    </div>
