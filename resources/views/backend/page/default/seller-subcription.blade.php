    ...
    <div class="main-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Seller Subscription Page') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
                        ...
                        <div class="site-card">
                            ...
                            <div class="site-card-body">
                                <form action="{{ route('admin.page.update') }}" method="post"
                                    ...
                                    @csrf
                                    <input type="hidden" name="page_code" value="pricing-plans">
                                    ...
                                    <div class="site-input-groups row">
                                        <label for="" class="col-sm-3 col-label">{{ __('Page Title') }}
                                            <i data-lucide="info" data-bs-toggle="tooltip"
                                                data-bs-original-title="Page Title will show on Breadcrumb"></i>
                                        </label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="site-input-groups row">
                                        <label for=""
                                            class="col-sm-3 col-label">{{ __('Plan Choose Title') }}</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="plan_choose_title" class="box-input"
                                                value="{{ $data->plan_choose_title }}">
                                        </div>
                                    </div>
            ...
            <div class="section-design-nb">
                <strong>NB:</strong>{{ __('All Pricing Plan will come from') }} <a
                    href="{{ route('admin.subscription.plan.index') }}">{{ __('Pricing Plan') }}</a>
                {{ __('page') }}
            </div>
