                ...
                <div class="col-xl-12">
                    <div class="site-tab-bars">
                        <ul>
                            ...
                            <li class="{{ isActive('admin.user.navigation.index', 'buyer') }}">
                                <a href="{{ route('admin.user.navigation.index', 'buyer') }}">
                                    <i data-lucide="user"></i>{{ __('Buyer Navigations') }}
                                </a>
                            </li>
                            <li class="{{ isActive('admin.user.navigation.index', 'seller') }}">
                                <a href="{{ route('admin.user.navigation.index', 'seller') }}">
                                    <i data-lucide="user"></i>{{ __('Seller Navigations') }}
                                </a>
                            </li>
                        </ul>
                    </div>
