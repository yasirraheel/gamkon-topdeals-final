                    ...
                    <div class="site-card overflow-hidden">
                        ...
                        <div class="site-card-body">
                            <div class="support-ticket-single-message user">
                                <div class="logo">
                                    <img class="avatar avatar-round" src="{{ asset($ticket->user->avatar_path)}}" alt="" height="40"
                                         width="40">
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="logo">
                                        @if( $message->model != 'admin')
                                            <img class="avatar avatar-round" src="{{ asset($ticket->user->avatar_path ?? 'global/materials/user.png')}}" alt=""
                                                 height="40" width="40">
                                        @else
