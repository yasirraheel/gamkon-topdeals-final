<div
    ...
    id="addNewBadge"
    tabindex="-1"
    aria-labelledby="addNewBadgeModalLabel"
    aria-hidden="true"
>
        ...
        <div class="modal-content site-table-modal">
            <div class="modal-body popup-body">
                ...
                <div class="popup-body-text">
                    <h3 class="title mb-4">{{ __('Add New Seller Ranking') }}</h3>
                    <form action="{{ route('admin.seller-ranking.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="site-input-groups mb-2">
                            <label class="box-input-label" for="">{{ __('Seller Ranking Icon:') }}</label>
                        ...
                        <div class="site-input-groups row mb-0">
                            ...
                            <div class="col-xl-6">
                                <div class="site-input-groups">
                                    <label for="" class="box-input-label">{{ __('Seller Ranking Name:') }}</label>
                                    <input type="text" name="portfolio_name" value="{{ old('portfolio_name') }}"
                                           class="box-input mb-0" placeholder="Seller Ranking Name" required=""/>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="site-input-groups">
                        ...
                        <div class="site-input-groups mb-0">
                            ...
                            <textarea name="description" class="form-textarea" placeholder="{{ __('Description') }}">{{ old('description') }}</textarea>
                        </div>
