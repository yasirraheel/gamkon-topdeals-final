            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                    <div class="site-chart">
                        <div class="site-card">
                            <div class="site-card-header">
                                <h3 class="title">{{ __('Listing View Analysis') }}</h3>
                            </div>
                            <div class="site-card-body">
                                <canvas id="listingViewChart"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="site-datatable">
                                <table class="data-table table mb-0">
                                    ...
                                    @foreach($data['latest_user'] as $user)
                                        <tr>
                                            <td class="icon">
                                                @include('backend.user.include.__avatar', ['avatar' => $user->avatar, 'avatar_path' => $user->avatar_path, 'first_name' => $user->first_name, 'last_name' => $user->last_name])
                                            </td>
                                            <td>
