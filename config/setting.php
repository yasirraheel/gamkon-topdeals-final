...
return [
    ...
    'tiered_pricing' => [
        'title' => 'Country-Based Tiered Pricing',
        'elements' => [
            [
                'type' => 'checkbox',
                'data' => 'boolean',
                'name' => 'tiered_pricing_enabled',
            ...
            [
                'type' => 'text',
                'data' => 'integer',
                'name' => 'tier_2_percentage',
                'label' => 'Tier 2 Percentage (%)',
                'rules' => 'required|integer|min:1|max:100',
                'value' => '70',
            ],
            [
            ...
            [
                'type' => 'text',
                'data' => 'integer',
                'name' => 'tier_3_percentage',
                'label' => 'Tier 3 Percentage (%)',
                'rules' => 'required|integer|min:1|max:100',
                'value' => '50',
            ],
            [
            ...
            [
                'type' => 'text',
                'data' => 'integer',
                'name' => 'tier_4_percentage',
                'label' => 'Tier 4 Percentage (%)',
                'rules' => 'required|integer|min:1|max:100',
                'value' => '40',
            ],
            [
                'type' => 'select',
                'data' => 'json',
                'name' => 'tier_4_countries',
                'label' => 'Tier 4 Countries',
                'rules' => 'nullable',
                'value' => '[]',
            ],
        ],
